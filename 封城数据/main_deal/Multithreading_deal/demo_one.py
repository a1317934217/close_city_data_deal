...
if __name__ == '__main__':
    file_path = "F:/封城数据处理/封城数据/石家庄/石家庄四阶/deal_03/"

    averagenodeconnectivity(file_path,"石家庄",Fourth_order_SJZ)
    get_city_degree(file_path,"石家庄",Fourth_order_SJZ)
    edge_number(file_path,"石家庄",Fourth_order_SJZ)
    naturecconnectivity(file_path,"石家庄",Fourth_order_SJZ)
