...
def function_encapsulation(first_data,second_data,listXData,ax1,title_name):
    ...
    plt.plot(listXData, first_data,  linewidth=2,  label='人口流入') #"4-",
    plt.plot(listXData, second_data, linewidth=2,  label='人口流出')#, "1--"
...
if __name__ == '__main__':
    # get_allCity_index()
    draw_all_city_flow(20210101,20210508)
