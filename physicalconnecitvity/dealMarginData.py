...
#
# (20210101,20210101)
deal_four_threshold_and_deal_city_name(20210901,20211031)
# deal_four_threshold_and_deal_city_name(20220101,20220228)
#
# deal_sameCol_in_Alonecsv(20210128,20210228)
deal_sameCol_in_Alonecsv(20210901,20211031)
# #
# merge_inAndout_final_data(20210101,20210228)
merge_inAndout_final_data(20210901,20211031)

# deal_name_bysmall_city()

# filename_test = "D:\\04python project\\01-爬虫-爬取百度迁徙数据\migrationof_BaiDu_spider\ChinaAreaCodes.csv"
# data_test = pd.read_csv(filename_test)
# ccccccc = data_test.loc[1]
# print(ccccccc[1])
# for row in data_test.itertuples():
#     # 元组的访问方式
#     print(row[1], getattr(row, 'code'))
...
# aa = "7.948044000000001e-05"
# bb = 0.333232232323
# print(as_num(float(aa)))
# print(as_num(bb))
