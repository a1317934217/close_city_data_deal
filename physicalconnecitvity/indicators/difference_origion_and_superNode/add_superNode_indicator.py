...
# @Author  : wuhao
# @Email   : guess?????
# @File    : add_superNode_indicator.py
import datetime
...
def draw_superNode(listData, nodeList):
    ...
    return average_clustering_origion, average_clustering_superNode, edge_number_origion, edge_number_superNode, \
           density_origion, density_superNode, global_efficiency_origion, global_efficiency_superNode, degree_origion, degree_superNode
...
degree_origion, degree_superNode = draw_superNode(listXData, nodeList)
