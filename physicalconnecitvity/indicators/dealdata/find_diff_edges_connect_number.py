...
filepath_front ="D:\\04python project\\01-爬虫-爬取百度迁徙数据\\physicalconnecitvity\\indicators\\data\\connect_number\\"
fileNamePath_one = "F:\\01大连民族\\百度迁徙爬取和数据\\百度迁徙数据-final\\03将两个In和Out相同行合并_最终数据\\"

remove_edge_list_diffedge =['0205-0206data_removeEdges.csv','0207-0208data_removeEdges.csv','0208-0209data_removeEdges.csv','0209-0210data_removeEdges.csv','0210-0211data_removeEdges.csv','0212-0213data_removeEdges.csv','0221-0222data_removeEdges.csv','0223-0224data_removeEdges.csv','0306-0307data_removeEdges.csv','0315-0316data_removeEdges.csv']
add_edge_list_diffedge =['0205-0206data_addEdges.csv' , '0207-0208data_addEdges.csv','0208-0209data_addEdges.csv','0209-0210data_addEdges.csv','0210-0211data_addEdges.csv','0212-0213data_addEdges.csv','0221-0222data_addEdges.csv','0223-0224data_addEdges.csv','0306-0307data_addEdges.csv','0315-0316data_addEdges.csv', ]
remove_edge_list_origionnet = ["20200205finalData.csv","20200207finalData.csv","20200208finalData.csv","20200209finalData.csv","20200210finalData.csv","20200212finalData.csv","20200221finalData.csv","20200223finalData.csv","20200306finalData.csv","20200315finalData.csv"]
