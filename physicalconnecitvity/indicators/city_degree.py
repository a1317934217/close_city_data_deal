...
def get_city_degree():
    ...
    for i in range(len(listXData)):
        ...
        try:
            ...
            list_city_degree.append(len(G.edges("石家庄")))
    print("(城市度)Y轴数值： ", list_city_degree)
    ...
    # plt.ylabel('度', fontproperties=font)
    # plt.title('百度迁徙2020上半年平均点连通性折线图', fontproperties=font)
    # ax.plot(listXData, list_city_degree,"m.-", linewidth=1, color='blue')
    # plt.show()
